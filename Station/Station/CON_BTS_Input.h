...
class CCON_BTS_Input : public CDialog
{
	DECLARE_DYNAMIC(CCON_BTS_Input)

public:
	CCON_BTS_Input(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CCON_BTS_Input();

// 对话框数据
	enum { IDD = IDD_CON_BTS_Input };
