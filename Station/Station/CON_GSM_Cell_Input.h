...
class CCON_GSM_Cell_Input : public CDialog
{
	DECLARE_DYNAMIC(CCON_GSM_Cell_Input)

public:
	CCON_GSM_Cell_Input(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CCON_GSM_Cell_Input();

// 对话框数据
	enum { IDD = IDD_CON_GSM_Cell_Input };
