...
class CPM_LTE_Region_Input : public CDialog
{
	DECLARE_DYNAMIC(CPM_LTE_Region_Input)

public:
	CPM_LTE_Region_Input(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CPM_LTE_Region_Input();

// 对话框数据
	enum { IDD = IDD_PM_LTE_REGION_Input };
