...
// CLTE_PM_Draw_Znit 窗体视图

class CLTE_PM_Draw_Znit : public CFormView
{
	DECLARE_DYNCREATE(CLTE_PM_Draw_Znit)

protected:
	CLTE_PM_Draw_Znit();           // 动态创建所使用的受保护的构造函数
	virtual ~CLTE_PM_Draw_Znit();

public:
	enum { IDD = IDD_LTE_PM_DRAW_Znit };
#ifdef _DEBUG
