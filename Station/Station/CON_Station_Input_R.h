...
class CCON_Station_Input_R : public CDialog
{
	DECLARE_DYNAMIC(CCON_Station_Input_R)

public:
	CCON_Station_Input_R(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CCON_Station_Input_R();

// 对话框数据
	enum { IDD = IDD_CON_Station_Input_R };
