...
class CCON_NodeB_Input : public CDialog
{
	DECLARE_DYNAMIC(CCON_NodeB_Input)

public:
	CCON_NodeB_Input(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CCON_NodeB_Input();

// 对话框数据
	enum { IDD = IDD_CON_NodeB_Input };
