...
// CPM_LTE_Case_Cal 窗体视图

class CPM_LTE_Case_Cal : public CFormView
{
	DECLARE_DYNCREATE(CPM_LTE_Case_Cal)

protected:
	CPM_LTE_Case_Cal();           // 动态创建所使用的受保护的构造函数
	virtual ~CPM_LTE_Case_Cal();

public:
	enum { IDD = IDD_PM_LTE_CASE_CAL };
#ifdef _DEBUG
