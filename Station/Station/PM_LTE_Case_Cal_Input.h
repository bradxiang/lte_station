...
class CPM_LTE_Case_Cal_Input : public CDialog
{
	DECLARE_DYNAMIC(CPM_LTE_Case_Cal_Input)

public:
	CPM_LTE_Case_Cal_Input(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CPM_LTE_Case_Cal_Input();

// 对话框数据
	enum { IDD = IDD_PM_LTE_CASE_CAL_Input };
