...
class CCON_Station_Input : public CDialog
{
	DECLARE_DYNAMIC(CCON_Station_Input)

public:
	CCON_Station_Input(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CCON_Station_Input();

// 对话框数据
	enum { IDD = IDD_CON_Station_Input };
