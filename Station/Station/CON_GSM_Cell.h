...
class CCON_GSM_Cell : public CFormView
{
	DECLARE_DYNCREATE(CCON_GSM_Cell)

protected:
	CCON_GSM_Cell();           // 动态创建所使用的受保护的构造函数
	virtual ~CCON_GSM_Cell();

public:
	enum { IDD = IDD_CON_GSM_Cell };
#ifdef _DEBUG
