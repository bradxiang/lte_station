...
// CPM_LTE_Case_PM 窗体视图

class CPM_LTE_Case_PM : public CFormView
{
	DECLARE_DYNCREATE(CPM_LTE_Case_PM)

protected:
	CPM_LTE_Case_PM();           // 动态创建所使用的受保护的构造函数
	virtual ~CPM_LTE_Case_PM();

public:
	enum { IDD = IDD_PM_LTE_CASE_PM };
#ifdef _DEBUG
