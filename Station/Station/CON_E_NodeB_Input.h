...
class CCON_E_NodeB_Input : public CDialog
{
	DECLARE_DYNAMIC(CCON_E_NodeB_Input)

public:
	CCON_E_NodeB_Input(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CCON_E_NodeB_Input();

// 对话框数据
	enum { IDD = IDD_CON_E_NodeB_Input };
