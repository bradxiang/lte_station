...
class CCON_TD_Cell_Input : public CDialog
{
	DECLARE_DYNAMIC(CCON_TD_Cell_Input)

public:
	CCON_TD_Cell_Input(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CCON_TD_Cell_Input();

// 对话框数据
	enum { IDD = IDD_CON_TD_Cell_Input };
