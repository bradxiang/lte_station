...
protected:
	CQUA_Element_TD();           // 动态创建所使用的受保护的构造函数
...
public:
	...
	//自定义
	void		My_Query_NodeB();										//查询：NodeB
	void		My_Query_Cell();										//查询：Cell
	void		My_LoadData_NodeB_Data(CString v_sSql);					//装载NodeB信息
	void		My_LoadData_Cell_Data(CString v_sSql);					//装载Cell信息
	void		My_LoadData_NodeB_Cell();								//装载NodeB_Cell信息
