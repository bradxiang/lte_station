...
class CPM_LTE_Case_PM_Input : public CDialog
{
	DECLARE_DYNAMIC(CPM_LTE_Case_PM_Input)

public:
	CPM_LTE_Case_PM_Input(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CPM_LTE_Case_PM_Input();

// 对话框数据
	enum { IDD = IDD_PM_LTE_CASE_PM_Input };
...
public:
	...
	void		My_Load_PM(mString_Int *v_mPM,mString_Int *v_mCase,mString_Int *v_mPM_Type);	//获取：性能
