...
class CCON_E_NodeB : public CFormView
{
	DECLARE_DYNCREATE(CCON_E_NodeB)

protected:
	CCON_E_NodeB();           // 动态创建所使用的受保护的构造函数
	virtual ~CCON_E_NodeB();

public:
	enum { IDD = IDD_CON_E_NodeB };
#ifdef _DEBUG
