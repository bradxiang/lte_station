...
{   
  ...
  // popmenu.AppendMenu(0, MF_SEPARATOR);   
    popmenu.AppendMenu(0, ID_RICH_CUT, "(&T)剪切");   
    popmenu.AppendMenu(0, ID_RICH_COPY, "(&C)复制");   
    popmenu.AppendMenu(0, ID_RICH_PASTE, "(&P)粘贴");   
  //  popmenu.AppendMenu(0, ID_RICH_CLEAR, "(&D)清除");   
 //   popmenu.AppendMenu(0, MF_SEPARATOR);   
    popmenu.AppendMenu(0, ID_RICH_SELECTALL, "(&A)全选");   
    popmenu.AppendMenu(0, MF_SEPARATOR);   
    popmenu.AppendMenu(0, ID_RICH_SETFONT, "(&F)字体");   
