...
CMyListCtrl::CMyListCtrl()
{
	...
	m_iCount=0;															//默认：计数器=0
	m_bEdit=false;														//默认：编辑无效
	m_iItem_EditNo=-1;													//默认：都可编辑
	for(int vi=0;vi<300;vi++)
...
//	参数：v_iCol：列号；
//-------------------------------------------------------------------------------------------------
void CMyListCtrl::SetEditNo_Col(int v_iCol)
{	
	m_iItem_EditNo=v_iCol;												//设置：不可编辑列
}
